...
var author$project$Main$productsDecoder = A2(
...
var author$project$Main$totalProducts = function (products) {
	return A3(
		elm$core$List$foldl,
		F2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text(
								'Total Inventory: ' + elm$core$String$fromInt(
									author$project$Main$totalProducts(products)))
							]))
					]));
		case 0:
			return elm$html$Html$text('Not Requested');
		case 1:
			return elm$html$Html$text('Fetching');
		default:
			switch (model.a.$) {
				case 0:
					var url = model.a.a;
					return elm$html$Html$text('Bar Url: ' + url);
				case 1:
					var _n1 = model.a;
				...
				case 3:
					var status = model.a.a;
					return elm$html$Html$text(
						'Bad Status: ' + elm$core$String$fromInt(status));
				default:
					var error = model.a.a;
					return elm$html$Html$text('Bad Body: ' + error);
			}
	}
};
...
var author$project$Main$main = elm$browser$Browser$element(
	{
		aF: function (flags) {
			return _Utils_Tuple2(
				author$project$Main$NotRequested,
				elm$http$Http$get(
					{
